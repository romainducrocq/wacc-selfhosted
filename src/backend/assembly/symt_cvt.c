...
static TInt get_struct_alignment(struct FrontEndContext* ctx, struct Structure* struct_type) {
...
static void cvt_fun_type(Ctx ctx, struct FunAttr* node, struct FunType* fun_type) {
